# Papéis e Responsabilidades — FinApp

**Responsável:** Filipe (GP)

| Membro | Papel | Responsabilidades principais |
|---|---|---|
| Filipe | Gerente de Projeto (GP) | Consolida o plano de projeto; conduz monitoramento e controle (EVM/burndown); reporta o andamento |
| Sara | Product Owner (PO) | Define e prioriza requisitos/backlog; representa a visão do produto |
